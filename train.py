...
The script also outputs the model as a .pickle file, and also exports two .tsv
files with the test data (features and labels) for evaluating the accuracy of
the model.
